...
//        manager = (ConnectionManager) wrappedRequest.getSession()
...
//        }
        if ((manager == null || !manager.isLoggedIn()) 
                && !wrappedRequest.getRequestURI().endsWith("/admin/login.xhtml")) {
            wrappedResponse.sendRedirect(wrappedRequest.getContextPath() + "/admin/login.xhtml");
